...
class ValueIterationAgent(ValueEstimationAgent):
  ...
  """
    ...
    """
        ...
        self.newValues = util.Counter()  # restore values of next iteration
        count = 0
    ...
    """
        ...
        QValue = 0
        for nextState, probability in TValues:
    ...
    """
        ...
        maxArgs = [i for i in range(len(QValues)) if QValues[i] == maxQValue]
        #self.values[state] = maxQValue
        self.newValues[state] = maxQValue
        return legalActions[maxArgs[0]]
